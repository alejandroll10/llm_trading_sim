...
class ShortSellTrader(BaseAgent):
    ...
    def make_decision(self, market_state: Dict, history: List, round_number: int) -> TradeDecision:
        ...
        target_price = current_price * (1 - 0.1 * gap_percentage + 0.2 * price_trend)
        ...
        if gap_percentage < self.threshold:
            return TradeDecision(
                ...
                price_prediction_reasoning=f"Expect price to move toward fundamental with momentum factor {price_trend:.2f}.",
